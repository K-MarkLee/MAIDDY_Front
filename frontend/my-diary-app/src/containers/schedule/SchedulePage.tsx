...
// SchedulePage의 return 부분만 수정
    return (
      <SharedLayout>
        ...
        <div className="overflow-y-auto h-[calc(100%-200px)] pt-4 pb-24 relative z-10" style={scheduleContainerStyle}>
