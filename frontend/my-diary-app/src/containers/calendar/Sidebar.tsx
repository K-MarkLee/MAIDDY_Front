      ...
      <AlertDialog open={showLogoutAlert} onOpenChange={setShowLogoutAlert}>
        <AlertDialogContent className="w-[280px] mx-auto rounded-xl bg-white/80 backdrop-blur-xl border border-white/40 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>정말로 로그아웃 하시겠습니까?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="rounded-xl hover:bg-violet-50/80 hover:text-violet-600 transition-all duration-300">
              취소
            </AlertDialogCancel>
            <AlertDialogAction
